    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('discount.update', $discounts) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" value="{{ $discounts->name }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $discounts->description }}"
                            ...
                            <div class="form-group">
                                <label>Value</label>
                                <input type="number" step="0.01" value="{{ $discounts->value }}"
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="active" class="selectgroup-input"
                                            @if ($discounts->status == 'active') checked @endif checked="">
                                        <span class="selectgroup-button">Active</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="inactive" class="selectgroup-input"
                                            @if ($discounts->status == 'inactive') checked @endif>
